...
var PriceLink = styled.a(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { style: { fontFamily: "Kanit,sans-serif", fontWeight: 400, fontSize: "16px" }, key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
...
var PriceLink$1 = styled.a(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var NavBody = styled.div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  justify-content: center;\n"], ["\n  position: relative;\n  display: flex;\n  justify-content: center;\n"])));
var NavBar = function (_a) {
    var linksFullScreen = _a.linksFullScreen;
    return (React.createElement(NavBody, null, linksFullScreen.map(function (link) {
        return (React.createElement(MenuEntry, { key: link.href, secondary: true, isActive: false },
            React.createElement(MenuLink, { href: link.href }, link.label)));
    })));
};
var templateObject_1$H;
        ...
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                !isMobile && (React.createElement("div", { style: { display: "inherit" } },
                    ...
                    React.createElement(Link, { external: true, key: "medium", href: "https://dumplingswapdefi.medium.com/", "aria-label": "medium", mr: "1" },
                        React.createElement(MediumIcon, __assign({}, iconProps))),
                    React.createElement(Link, { external: true, key: "git", href: "https://github.com/dumplingswap", "aria-label": "github", mr: "1" },
